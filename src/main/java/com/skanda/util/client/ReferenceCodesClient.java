...
public class ReferenceCodesClient {
    ...
    private static final String URI = "http://localhost:8084/reference-codes/codeType/";

    public ReferenceCodes fetchRefCodes(String codeType) {
        try {
            ...
            if (codes == null || codes.isEmpty()) {
                throw new CodeTypeNotFoundException("Invalid codeType: " + codeType);
            }
